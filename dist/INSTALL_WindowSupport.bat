...
if not exist "%SOURCE_DIR%WindowPowerShellProvider" (
    echo [ERROR] WindowPowerShellProvider folder not found in: %SOURCE_DIR%
    echo.
    ...
    echo.
    echo Please make sure you have built the executables first.
    echo Run: PowerShell -ExecutionPolicy Bypass -File .\rebuild_all.ps1
    echo.
    pause
    exit /b 1
)
